...
<dl>
  ...
  <dd>Jim is a Lecturer at the University of Edinburgh.  Topographica
      is inspired by Jim's C++ <a target="_top"
  ...
  <dd>Julien recently received an MSc from the University of Edinburgh
      ...
      working on transformation functions.
  ...
  <dd>Judah is a PhD student at the University of Texas (topic:
      ...
      responsible for implementing plotting support and other GUI items.
  <p><dt>Alan Lindsay, September 2005-</dt>
  <dd>Alan will be finishing up his undergraduate degree at the
      University of Edinburgh in 2006.  He is implementing a GUI
      interface for specifying Topographica models by selecting and
  ...
  <dd>Louise will also be finishing up her undergraduate degree at the
      University of Edinburgh in 2006.  She is implementing published
      models of visual cortex maps (other than LISSOM).  This effort
      will help ensure that Topographica has general-purpose support
      for maps, and will build a library of starting points for future
      studies (e.g. comparison studies).
  ...
  <dd>Jeff is a PhD student at the University of Texas (topic:
      ...
      in Scheme, then in Python), and most of the foundational classes
      (Sheet, CFSheet, CFSOM TopoObject, LISSOM, etc.).  He has now
      moved on to try to finish his PhD and get a job :-), but is
      still available for consulting and help on specific issues.
  <p><dt><a target="_top"
