...
turn on <span class='t_item'>Strength only</span>; it is usually off by default.
...
is true of the map generated by the LISSOM network:
...
2.0 to see a reasonable response from this model V1, and you may want
to enlarge the image size to look at details.
...
then in V1, and then gradually change within V1.
...
responds at 0.10.
The delay from the LGN to V1 is also 0.05, so V1 is first activated at
time 0.15.
...
V1 activations reaches a fixed limit for LISSOM (usually about 10
