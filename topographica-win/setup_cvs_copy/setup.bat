...
echo.
echo On your computer, these are likely to be located inside a
echo folder with your username, in either:
echo %TEMP%
echo or:
echo %TMP%
echo (which could be the same, depending on your computer's setup).
:exit
echo.
pause
echo.
