...
def matrix_hsv_to_rgb(hMapArray,sMapArray,vMapArray):
	...
	topo.base.topoobject.ParameterizedObject().warning('HSVBitmap inputs exceed 1. Clipping to 1.0')
...
class TestPlot(unittest.TestCase):
	...
	self.plot9 = make_template_plot(plot_channels9,self.sheet.sheet_view_dict,name='plot9')
