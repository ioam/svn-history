...
pgt = new_plotgroup_template(name='Contrast Response Fullfield',command='measure_contrast_response_fullfield()',initial_plot=False,plotcommand='tuning_curve(x_axis="contrast", plot_type=pylab.semilogx,x_ticks=None,x_labels=None,x_lim=None, unit="%")',template_plot_type="curve",prerequisites=['OrientationPreference'])
