...
list of PlotTemplates.  Each PlotTemplate can produce up to one plot
per Sheet in the network.  The definitions for each of these templates
can be done in advance of defining any particular model, and rarely
require any editing for any particular model.
