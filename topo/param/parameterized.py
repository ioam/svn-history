...
class OptionalSingleton(object):
    ...
    def __deepcopy__(self,m):
        if self._singleton:
            ...
            new_obj = self.__class__(self._singleton)
            new_obj.__dict__ = copy.deepcopy(self.__dict__,m)
            return new_obj
...
# From infinitesque.net/articles/2005/enhancing%20Python's%20property.xhtml
# Solves the problem of overriding property methods in subclasses.
