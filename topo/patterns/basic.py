...
class GaussianGenerator(PatternGenerator):
    ...
    width   = Number(default=0.2,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.2)
    height  = Number(default=0.2,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.21)
...
class SineGratingGenerator(PatternGenerator):
    ...
    frequency = Number(default=2.4,bounds=(0.0,None),softbounds=(0.0,10.0),precedence=0.1)
    phase     = Number(default=0.0,bounds=(0.0,None),softbounds=(0.0,2*pi),precedence=0.11)
...
class GaborGenerator(PatternGenerator):
    ...
    frequency = Number(default=5.0,bounds=(0.0,None),softbounds=(0.0,10.0),precedence=0.1)
    phase     = Number(default=0.0,bounds=(0.0,None),softbounds=(0.0,2*pi),precedence=0.11)
    width   = Number(default=0.2,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.2)
    height  = Number(default=0.2,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.21)
...
class LineGenerator(PatternGenerator):
    ...
    thickness   = Number(default=0.006,bounds=(0.0,None),softbounds=(0.0,0.075),precedence=0.3)
    smoothing = Number(default=0.05,bounds=(0.0,None),softbounds=(0.0,0.075),precedence=0.4)
    ...
    scale = Number(default=0.7,softbounds=(0.0,2.0),precedence=0.8)
...
class DiskGenerator(PatternGenerator):
    ...
    width  = Number(default=0.5,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.2)
    height  = Number(default=0.5,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.21)
    smoothing = Number(default=0.07,bounds=(0.0,None),softbounds=(0.0,0.5),precedence=0.4)
...
class RingGenerator(PatternGenerator):
    ...
    thickness   = Number(default=0.015,bounds=(0.0,None),softbounds=(0.0,0.5),precedence=0.3)
    width  = Number(default=0.5,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.2)
    height  = Number(default=0.5,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.21)
    smoothing = Number(default=0.07,bounds=(0.0,None),softbounds=(0.0,0.5),precedence=0.4)
...
class RectangleGenerator(PatternGenerator):
    ...
    width   = Number(default=0.2,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.2)
    height  = Number(default=0.4,bounds=(0.0,None),softbounds=(0.0,1.0),precedence=0.21)
