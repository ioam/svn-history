...
# JABALERT: How did this class reappear here?  Surely it should disappear again?
#
...
class PatternSampler(ParameterizedObject):
    ...
    ###TRALERT:simple method to help in presenting binocular images
    ###Need to be suppressed, the script for presenting stereo images is just a temporary implementation
